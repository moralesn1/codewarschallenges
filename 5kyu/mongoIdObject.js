...
// As in any database, you can create, read, update, and delete elements. But in constrast to SQL,
//  when you create an element, a new field _id is created. This field is unique and contains some
//   information about the time the element was created, id of the process that created it, and so
//    on. More information can be found in the MongoDB documentation (which you have to read in order
//      to implement this Kata).
...
// (the XXX in http://www.codewars.com/dojo/katas/XXX/train/javascript) is really similar to MongoDB's ids,
// which brings us to the conjecture that this is the database powering Codewars.

// Examples
// The verification method will return true if an element provided is a valid Mongo string and false
// otherwise:
...
// The timestamp method will return a date/time object from the timestamp of the Mongo string and
// false otherwise:
...
// When you will implement this correctly, you will not only get some points, but also would
// be able to check creation time of all the kata here :-)
